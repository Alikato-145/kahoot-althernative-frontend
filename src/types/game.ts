import type { Quiz, QuizTiming, Question } from './quiz'
export type GamePhase = 'lobby' | 'question-intro' | 'answering' | 'reveal' | 'score-rank' | 'final-results'
export type GameState = { sessionId: string; quizId: string; pin: string; phase: GamePhase; currentQuestionIndex: number | null; openedAt: number | null; deadlineAt: number | null; timing: QuizTiming }
